...
List<EventTypeModel> getEventTypes(){
  ...
  //1
  eventModel.imgAssetPath = "images/concert.png";
  ...
  //1
  eventModel.imgAssetPath = "images/sports.png";
  ...
  //1
  eventModel.imgAssetPath = "images/education.png";
...
List<EventsModel> getEvents(){
  ...
  //1
  eventsModel.imageAssetPath = "images/tileimg.png";
  ...
  //2
  eventsModel.imageAssetPath = "images/second.png";
  eventsModel.date = "Jan 12, 2019";
  ...
  //3
  eventsModel.imageAssetPath = "images/music_event.png";
  eventsModel.date = "Jan 12, 2019";
  eventsModel.address = "Galaxyfields, Sector 22, Faridabad";
