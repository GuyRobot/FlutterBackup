...
class _ButtonLoginAnimationState extends State<ButtonLoginAnimation>
  ...
  void initState() {
    ...
    _positionAnimation =
        Tween<double>(begin: 10.0, end: 256.0).animate(_positionController)
            ...
            if (status == AnimationStatus.completed) {
              Navigator.push(context, PageTransition(
                ...
                _scaleController.reverse().then((value) {
                  _isIconHide = false;
                  _positionController.reverse().then((value) {
                    setState(() {
                      _isLogin = false;
                    });
                  });
                      ...
                      child: AnimatedBuilder(
                        ...
                        builder: (context, child) => Transform.scale(
                          ...
                          child: Container(
                            ...
                            width: 48,
                            decoration: BoxDecoration(
                                color: widget.borderColor, shape: BoxShape.circle),
                            child: !_isIconHide ? Icon(
                              Icons.arrow_forward,
                              color: widget.fontColor,
                              size: 32,
                            ) : Container(),
